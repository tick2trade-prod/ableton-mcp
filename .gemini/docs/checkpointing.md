# Checkpointing in Gemini CLI

The concept of "checkpointing" as a built-in feature for automatically tracking and rewinding file edits, as seen in some other AI CLI tools, is not a documented feature of Gemini CLI.

For more information on available features in Gemini CLI, please refer to the [official Gemini CLI documentation](https://geminicli.com/docs/).

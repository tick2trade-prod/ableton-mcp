# Interactive Mode in Gemini CLI

A detailed guide on "Interactive Mode," including specific keyboard shortcuts and advanced features, is not available in the Gemini CLI documentation. The CLI operates in an interactive REPL by default.

For more information on available features, please refer to the [official Gemini CLI documentation](https://geminicli.com/docs/).

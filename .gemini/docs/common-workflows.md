# Common Workflows for Gemini CLI

The Gemini CLI documentation does not currently provide a dedicated section for "Common Workflows".

For examples and usage, please refer to the main page of the [official Gemini CLI documentation](httpss://geminicli.com/docs/).
